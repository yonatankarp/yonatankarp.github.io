...
![Parallel execution of 2 tasks](/images/blog/parallel-execution.svg)
...
![Concurrent execution of 2 tasks](/images/blog/concurrent-execution.svg)
...
```mermaid
flowchart LR
    EQ[Execution Queue] -->|current execution| EX((Execution))
    EX -->|blocked execution| BQ[Blocked Queue]
    BQ -->|return to execution queue| EQ
```
