...
```bash
make serve   # dev server at http://localhost:1313 using the pinned local Hugo when available
make build   # production build using the pinned local Hugo when available
